...
export const Bottom2 = (props) => {
  return (
      <TouchableOpacity onPress={props.addToCart} activeOpacity={1} style={styles.bottomView}>
        <Text style={styles.textStyle}>Add Items In Cart</Text>
      </TouchableOpacity>
    );
...
export const UpdateAddress = (props) => {
  return (
      <TouchableOpacity onPress={props.Update} activeOpacity={1} style={styles.bottomView}>
...
export const DrawerBottom = (props) => {
  return (
      <TouchableOpacity onPress={props.navigation}
        ...
        <AntDesign name="logout" size={20} color="#76BA1B" />
